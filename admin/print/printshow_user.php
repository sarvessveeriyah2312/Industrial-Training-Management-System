                ...
                <thead>
                    <tr>
                        <th class='tpl-bar-breadcrumbs' colspan='9'>User Record
                            ...
                            <a title='Back User Record'  href='../show_user.php'><button class='edit-button' style='visibility:visible;width: 43px;height: 32px;line-height: 32px;margin: 5px;'>Back</button></a> <a title='Print User Record'><button class='edit-button' onclick= window.print() style='visibility:visible;width: 43px;height: 32px;line-height: 32px;margin: 5px;'>Print</button></a>
                            </th>
