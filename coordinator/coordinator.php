...
<body>
  <nav id='nav'>
    <ul>
        ...
        <li><a href='job_opening_show'>Job Openings</a></li>
...
<div class='table_container'>
        ...
        <div id=head_msg>Overall Stats of MyLI</div><br>
            ...
            // --------------------------------------------------------- 1st ROW
                ...
                $result=mysqli_query($con, $str);
                $row=mysqli_fetch_array($result);
                echo "<th class='tg-031e' rowspan='5'><div class='num'>$row[0]</div><br><div class='stats_head'>Faculty Supervisors</div></th>";
            ...
            // --------------------------------------------------------- 3rd ROW
                ...
                // no of internship by companies
                require "connection.php";
                $str="select count(*)from job_db where description='Internship';";
                mysqli_query($con, $str);
                $result=mysqli_query($con, $str);
                $row=mysqli_fetch_array($result);
                echo "<th class='tg-031e' rowspan='2'><div class='num'>$row[0]</div><br><div class='stats_head'>Internship by Companies</div></th>";

                // # of internship offer
                require "connection.php";
                $str="select sum(position)from job_db where description='Internship';";
                mysqli_query($con, $str);
                $result=mysqli_query($con, $str);
                $row=mysqli_fetch_array($result);
                echo "<td class='tg-031e'><div class='stats_sub'># Internship Offer:<div class='num_sub'>$row[0]</div></div></td>";
            ...
            <tr>";
            // --------------------------------------------------------- 4th ROW
                // no of course per students
                require "connection.php";
                $str="select count(*) from student_details;";
                mysqli_query($con, $str);
                $result=mysqli_query($con, $str);
                $row=mysqli_fetch_array($result);
                echo "<th class='tg-031e' rowspan='5'><div class='num'>$row[0]</div><br><div class='stats_head'>Students per Department</div></th>";

                // # of students of Software Engineering
                require "connection.php";
                $str="select count(*) from student_details where course='Software Engineering';";
                mysqli_query($con, $str);
                $result=mysqli_query($con, $str);
                $row=mysqli_fetch_array($result);
                echo "<td class='tg-031e'><div class='stats_sub'># Software Engineering:<div class='num_sub'>$row[0]</div></div></td>";

                // no of presentation
                $str="select count(*) from presentation_db;";
                mysqli_query($con, $str);
                $result=mysqli_query($con, $str);
                $row=mysqli_fetch_array($result);
                echo "<th class='tg-031e' rowspan='5'><div class='num'>$row[0]</div><br><div class='stats_head'>Presentation by Department</div></th>";

                // # of presentation schedule
                require "connection.php";
                $str="select count(*) from presentation_allot;";
                mysqli_query($con, $str);
                $result=mysqli_query($con, $str);
                $row=mysqli_fetch_array($result);
                echo "<td class='tg-031e' rowspan='2'><div class='stats_sub'># Student for Presentation :<div class='num_sub'>$row[0]</div></div></td>";

                echo"
            </tr>
            <tr>";
                // # of students of Networking
                require "connection.php";
                $str="select count(*) from student_details where course='Networking';";
                mysqli_query($con, $str);
                $result=mysqli_query($con, $str);
                $row=mysqli_fetch_array($result);
                echo "<td class='tg-031e'><div class='stats_sub'># Networking:<div class='num_sub'>$row[0]</div></div></td>";
                
                echo" 
            </tr>
            <tr>";
                // # of students of Multimedia
                require "connection.php";
                $str="select count(*) from student_details where course='Multimedia';";
                mysqli_query($con, $str);
                $result=mysqli_query($con, $str);
                $row=mysqli_fetch_array($result);
                echo "<td class='tg-031e'><div class='stats_sub'># Multimedia:<div class='num_sub'>$row[0]</div></div></td>";
...
<div class='table_container'>
        <div class='sub-table-container' >
            ...
            <table class='tc' >
                <thead>
                    <tr>
                        <th class='tpl-bar-breadcrumbs' colspan='11'>Student Record
