                ...
                if(isset($_GET['faculty_id'])) {
                    ...
                    <div class='sub-table-container' >
                        ...
                        <table class='tc' >
                            <thead>
                                <tr>
                                    <th class='tpl-bar-breadcrumbs' colspan='6'>List of student selected for : $faculty_id
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                $str = "Select a.student_id, a.first_name, a.middle_name, a.last_name, a.email, b.status from student_details a, statusf_db b where a.student_id=b.student_id and b.fac_id in (SELECT fac_id FROM `fac_db` WHERE faculty_id='$faculty_id');";
