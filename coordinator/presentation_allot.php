                ...
                <table class='tc'>
                    ...
                    <tbody>
                        <tr class='row'>
                            ...
                            <td class='item'>
                            <select name='student_id' onchange='x(this)'>
                ...
                <table class='tc' >
                    ...
                    <tbody>
                        <tr class='row'>
                            ...
                            <td class='item'>Assign a Presentation</td>
                        </tr>";

                        require "../connection.php";
                        $str="select * from presentation_db where presentation_id in (select presentation_id from presentation_allot where student_id='$student_id');";
                        ...
                        while($row=mysqli_fetch_array($result)) {
                            if($x==1) {
                                ...
                                <td onclick='z(this)' class='item alter'><a href='presentation_manipulate.php?student_id=$student_id&presentation_id=$row[0]&status=delete' style='font-size:20px'><b>✓</b></a></td>
                            </tr>";
                            ...
                            <td onclick='z(this)' class='item'><a href='presentation_manipulate.php?student_id=$student_id&presentation_id=$row[0]&status=delete' style='font-size:20px'><b>✓</b></a></td>
                            ";
                        }
                        ...
                        require "../connection.php";
                        $str="select * from presentation_db where presentation_id not in (select presentation_id from presentation_allot where student_id='$student_id');";
                        $result=mysqli_query($con, $str);
                        while($row=mysqli_fetch_array($result)) {
                            if($x==1) {
                                $x=0;
                                ...
                                <td class='item alter'>$row[3]</td>
                                <td class='item alter'>$row[4]</td>
                                <td onclick='z(this)' class='item alter'><a href='presentation_manipulate.php?student_id=$student_id&presentation_id=$row[0]&status=add' style='font-size:20px'><b>□</b></a></td>
                            </tr>";
                            ...
                            <td class='item'>$row[3]</td>
                            <td class='item'>$row[4]</td>
                            <td onclick='z(this)' class='item'><a href='presentation_manipulate.php?student_id=$student_id&presentation_id=$row[0]&status=add' style='font-size:20px'><b>□</b></a></td>
                            ";
                        }
