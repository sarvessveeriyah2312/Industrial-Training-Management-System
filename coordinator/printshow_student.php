                ...
                <thead>
                    <tr>
                        <th class='tpl-bar-breadcrumbs' colspan='10'>Student Record
                            ...
                            <a title='Print Student record'><button class='edit-button' onclick= window.print() style='visibility:visible;width: 43px;height: 32px;line-height: 32px;margin: 5px;'>Print</button></a>
