                ...
                <table class='tc' >
                    ...
                    <tbody>
                        <tr class='row'>
                            ...
                            <td class='item'>Assign a Project</td>
                        </tr>";

                        require "../connection.php";
                        $str="select * from project_db where project_id in (select project_id from project_allot where student_id='$student_id');";
                        ...
                        while($row=mysqli_fetch_array($result)) {
                            if($x==1) {
                                ...
                                <td onclick='z(this)' class='item alter'><a href='project_manipulate.php?student_id=$student_id&project_id=$row[0]&status=delete' style='font-size:20px'><b>✓</b></a></td>
                            </tr>";
                            ...
                            <td onclick='z(this)' class='item'><a href='project_manipulate.php?student_id=$student_id&project_id=$row[0]&status=delete' style='font-size:20px'><b>✓</b></a></td>
                            ";
                        }
                        ...
                        require "../connection.php";
                        $str="select * from project_db where project_id not in (select project_id from project_allot where student_id='$student_id');";
                        $result=mysqli_query($con, $str);
                        while($row=mysqli_fetch_array($result)) {
                            if($x==1) {
                                $x=0;
                                ...
                                <td class='item alter'>$row[2]</td>
                                <td class='item alter'>$row[3]</td>
                                <td onclick='z(this)' class='item alter'><a href='project_manipulate.php?student_id=$student_id&project_id=$row[0]&status=add' style='font-size:20px'><b>□</b></a></td>
                            </tr>";
                            ...
                            <td class='item'>$row[2]</td>
                            <td class='item'>$row[3]</td>
                            <td onclick='z(this)' class='item'><a href='project_manipulate.php?student_id=$student_id&project_id=$row[0]&status=add' style='font-size:20px'><b>□</b></a></td>
                            ";
                        }
