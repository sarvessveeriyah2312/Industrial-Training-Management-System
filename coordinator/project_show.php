                    ...
                    <tbody>
                        ...
                        while($row=mysqli_fetch_array($result)) {
                            if($x==1) {
                                ...
                                <td class='item alter'>$row[1]<a href='project_view_details.php?id=$row[0]'><button class='edit-button' >View</button><a href='project_edit.php?project_id=$row[0]'><button class='edit-button' >Edit</button></a></td>
                            ...
                            <td class='item'>$row[1]<a href='project_view_details.php?id=$row[0]'><button class='edit-button' >View</button><a href='project_edit.php?project_id=$row[0]'><button class='edit-button' >Edit</button></a></td>
