                ...
                <thead>
                    <tr>
                        <th class='tpl-bar-breadcrumbs' colspan='11'>Student Record
                            ...
                            <a href='printshow_student.php' title='Print Student record'><button class='edit-button' style='visibility:visible;width: 55px;height: 32px;line-height: 32px;margin: 5px;'>Record</button></a>
