...
if(isset($_GET['submit'])) {
    ...
    $str_student_details="insert into student_details values('".$_GET['student_id']."', '".$_GET['first_name']."', '".$_GET['middle_name']."', '".$_GET['last_name']."', '".$_GET['email']."', '".$_GET['telephone']."', '".$_GET['status']."', '".$_GET['sem_reg']."', '".$_GET['course']."', '".$_GET['status_fsv']."')";
                        ...
                        <table class='tc'>
                            ...
                            <tbody>
                                ...
                                <tr class='row'>
                                    ...
                                    <td class='item'><input name='course' type='text' required value=''></td>
                                </tr>
                                
                                <td class='item alter'>Status FSV</td>

                                    <td class='item alter'>
                                    <select name='status_fsv' disabled>
                                        <option value='Not Assign' selected readonly>Undecided</option>
                                    </select>
                                    <div style='color:grey'>*info:Status automatically changes when allottment is made.</div>
                                    </td>
                        </tr>
