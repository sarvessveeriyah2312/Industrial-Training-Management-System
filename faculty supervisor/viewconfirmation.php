                ...
                <div class='table_container'>
                    <div class='sub-table-container'>
                        <table class='tc'>
                            <thead>
                                <tr>
                                    <th class='tpl-bar-breadcrumbs' colspan='2'>Show Confirmation Letter</th>
                                </tr>
                            </thead>

                            <tbody>
                                <tr class='row'>
                                    <td class='item'>Confirmation ID</td>
                                    <td class='item'><select name='confirmation_id' onchange='x(this)'>
                                        <option value='' > select </option>";
                                        require "../connection.php";
                                        $str1="select id from tbl_files";
                ...
                if(isset($_GET['confirmation_id'])) {
                    ...
                    <div class='sub-table-container' >
                        ...
                        <table class='tc' >
                            <thead>
                                <tr>
                                    <th class='tpl-bar-breadcrumbs' colspan='5'>Confirmation Letter : $confirmation_id
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class='row'>
                                    <td class='item'>File Name</td>
                                    <td class='item'>Uploaded Date</td>
                                ...
                                require "../connection.php";
                                $str= "Select * FROM tbl_files WHERE id='$confirmation_id'";
                                ...
                                while($row=mysqli_fetch_array($result)) {
                                    if($x==1) {
                                        ...
                                        <td class='item alter'><a href='delete_record.php?file=viewconfirmation.php&table=tbl_files&pkey_name=id&key=$confirmation_id' title='Delete Confirmation Letter from Record'>✖</a></td>
                                    </tr>";
                                    ...
                                    <td class='item'><a href='delete_record.php?file=viewconfirmation.php&table=tbl_files&pkey_name=id&key=$confirmation_id' title='Delete Confirmation Letter from Record'>✖</a></td>
                                    ";
                                }
                            }
                            echo "
