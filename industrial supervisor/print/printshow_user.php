                ...
                <thead>
                    <tr>
                        <th class='tpl-bar-breadcrumbs' colspan='9'>User Record
                            ...
                            <a title='Back User Record'  href='../show_user.php'><button class='edit-button' style='visibility:visible;width: 43px;height: 32px;line-height: 32px;margin: left;'>Back</button></a>
