...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2021 at 09:53 AM
...
INSERT INTO `activityrecord` (`id`, `name`, `task`, `progress`, `start_date`, `end_date`, `marks`) VALUES
(1, 'Lai Yin Han', '3D Rendering', 'Done', '2021-04-01', '2021-04-08', 72),
(2, 'Lai Yin Han', 'Data analytic ', 'Done', '2021-05-13', '2021-05-20', 82),
(3, 'Lai Yin Han', '3D Texturing', 'Done', '2021-04-05', '2021-04-07', 66),
(4, 'Lai Yin Han', '3D modeling', 'Processing', '2021-05-31', '0000-00-00', 0),
(5, 'Lai Yin Han', 'Outing', 'Done', '2021-05-21', '2021-05-22', 100),
(6, 'Lai Yin Han', 'Python', 'Processing', '2021-06-04', '0000-00-00', 0);
...
INSERT INTO `attendance` (`month`, `attendance_percentage`) VALUES
('April', 86),
('May', 100),
('June', 16);
...
--
-- Table structure for table `confirmation_letter`
--

CREATE TABLE `confirmation_letter` (
...
--
-- Table structure for table `fsupervisor`
--

CREATE TABLE `fsupervisor` (
  `Fsupervisor_id` int(11) NOT NULL,
  `Fsupervisor_name` varchar(50) NOT NULL,
  `Fsupervisor_age` int(11) NOT NULL,
  `Fsupervisor_email` varchar(50) NOT NULL,
  `Fsupervisor_telephone` int(20) NOT NULL,
  `Fsupervisor_department` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `fsupervisor`
--

INSERT INTO `fsupervisor` (`Fsupervisor_id`, `Fsupervisor_name`, `Fsupervisor_age`, `Fsupervisor_email`, `Fsupervisor_telephone`, `Fsupervisor_department`) VALUES
(12342, 'Nurul Shazuni', 32, 'nurulshazuni@gmail.com', 1113456776, 'IT');

-- --------------------------------------------------------

--
-- Table structure for table `ind_sv_evaluate`
--

CREATE TABLE `ind_sv_evaluate` (
  `id` varchar(30) NOT NULL,
  `daily_marks` int(30) NOT NULL,
  `weekly_marks` int(30) NOT NULL,
  `logbook` int(30) NOT NULL,
  `presentation` int(11) NOT NULL,
  `total` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `ind_sv_evaluate`
--

INSERT INTO `ind_sv_evaluate` (`id`, `daily_marks`, `weekly_marks`, `logbook`, `presentation`, `total`) VALUES
('2', 5, 10, 10, 3, 0),
('1000', 5, 6, 5, 9, 0),
('1002', 5, 6, 9, 1, 0),
('1', 10, 10, 10, 50, 0),
('67', 67, 56, 45, 34, 0),
('DA2314', 90, 80, 10, 34, 54);

-- --------------------------------------------------------

--
-- Table structure for table `ind_sv_feedback`
--

CREATE TABLE `ind_sv_feedback` (
  `id` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `feedback` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `ind_sv_feedback`
--

INSERT INTO `ind_sv_feedback` (`id`, `feedback`) VALUES
('CB2001', ''),
('CB2001', 'Excellent'),
('6', 'Moderate');
...
--
-- Table structure for table `isupervisor`
--

CREATE TABLE `isupervisor` (
  `Isupervisor_id` int(11) NOT NULL,
  `Isupervisor_name` varchar(50) NOT NULL,
  `Isupervisor_age` int(11) NOT NULL,
  `Isupervisor_email` varchar(50) NOT NULL,
  `Isupervisor_telephone` int(11) NOT NULL,
  `Isupervisor_department` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `isupervisor`
--

INSERT INTO `isupervisor` (`Isupervisor_id`, `Isupervisor_name`, `Isupervisor_age`, `Isupervisor_email`, `Isupervisor_telephone`, `Isupervisor_department`) VALUES
(12342, 'Mohammad Fahmi', 29, 'fahmi0212@gmail.com', 148324121, 'IT');
...
CREATE TABLE `logbook` (
  ...
  `date` date NOT NULL,
  `progress` varchar(150) COLLATE utf8_unicode_ci NOT NULL
...
INSERT INTO `logbook` (`id`, `title`, `date`, `progress`) VALUES
('CB2001', 'Progress Day 1', '2021-06-01', 'Ice Breaking Sessions with workmates'),
('CB2002', 'Progress Day 2', '2021-06-02', 'Office Presentation regarding SDLC');
...
('CP202145', '3.56', '3.56', '4.00', '3.60', '100.00', '40.00', '0.00');
...
('1002', 'Balang', 'babi', 'Alucard', 'adlucard@myli.com', '798745855', '', 'Fall 2013', 'Computer network', ''),
('1003', 'Seven', 'AL', 'Ottlieb', 'Ottlieb@uow.ca', '760969875', 'Undecided', 'Summer 2011', 'Networking', 'Not Assign'),
('10054', 'Peter', 'Pedro', 'Franken', 'Franken@uow.ca', '987687005', 'Hired', 'Spring 2013', 'Multimedia', 'Not Assign'),
('CA19022', 'Karina', 'binti', ' Ahmad', 'CA19022@std.ump.my', '6012345666', '', 'Sem 8', 'Networking', ''),
...
(4, 'INDIVIDUAL COVER PAGE.pdf', '2021-06-10 08:05:11');
...
('0001', 'Student2', 'student', 123456789, 'student2@myli.com', 'student'),
('0002', 'Student3', 'student', 1232457698, 'student3@myli.com', 'student');
