...
<tbody><center>		
		<!-- insert users -->
		<section class="section-1">
				<form action="addStudentForm.php" method="POST">
				<input type="hidden" name="action" value="insert">
					<center>
						<table>
							...
							<tr>
								<th>Task</th>
								<td><input type="text" id="task" name="task" placeholder="Task"></td>
							</tr>
							
							<tr>
								<th>Progress</th>
								<td><input type="text" id="progress" name="progress" placeholder="Progress"></td>
							</tr>
						...
						<input type="submit" value="Submit" name="Confirm" onclick="addStudent()">
  ...
  function addStudent()
  {
	if (confirm("Please confirm that all the details of the user is correct"))
	{
		alert("The user details was successfully inserted into the system");
	}
	else
	{
		alert("Cancelled");
